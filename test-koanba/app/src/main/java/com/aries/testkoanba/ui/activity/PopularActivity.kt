...
class PopularActivity : AppCompatActivity() , MainView.View, SwipeRefreshLayout.OnRefreshListener{
    private var presenterImpl: PopularPresenterImpl? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenterImpl = PopularPresenterImpl(this)
